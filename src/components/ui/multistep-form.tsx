          ...
          <div key={step.id} className="flex items-center">
            <button
              ...
              className={cn(
                ...
                index > currentStep && "bg-muted/60 text-muted-foreground/50"
              )}
            >
              {index < currentStep ? (
            ...
            {index < steps.length - 1 && (
              <div className="relative mx-2 h-[2px] w-8 overflow-hidden rounded-full bg-muted">
                <motion.div
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <Input
            ...
            className="h-14 text-base transition-all duration-300 border-input focus:border-primary/50 bg-muted/30"
          />

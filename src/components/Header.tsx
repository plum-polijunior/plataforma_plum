...
// Ordem alinhada ao DOM/scroll-spy real (FAQ antes de Localização) — ver
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-[72px] gap-6">
          ...
          <nav className="hidden md:flex items-center gap-1 ml-auto">
            ...
            {/*
              Único ponto em que este Header se afasta da rafaela: o CTA do
              mockup rola até #contato porque não existe app de verdade atrás
              dele. Aqui existe, então continua indo para /auth — ver
              docs/2026-08-12-PLANO-merge-landing-page.md §3.
            */}
            <Button
              variant="hero"
